...
#### Pattern Components
- Input Repository - The input for your processor is stored here and should be reachable by the processor. This could be S3-based object store or a 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY0MTU1NDUxNiwxMzI3Mzg1NTIsMTUwOT
