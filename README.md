...
We will use the Container-on-Demand pattern to build a video th on-demand task to generate thumbnail images from video files and use the Scaling-Container to build the Bean-Counter auto-scaling service that finds the value of the coins thrown on a table.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTM4NjcyNzgsLTE3NDM0NjQ0NjldfQ
==
-->