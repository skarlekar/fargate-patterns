...
### Problem
While AWS Lambda allows you to run functions as a service allowing you to build applications as conglomeration of serverless microservices reacting to events eschewing simple development of core functionalities, easy deployment, automatic scaling and fault tolerance to, it has a few limitations 
<!--stackedit_data:
eyJoaXN0b3J5IjpbODc0NTQ1NDE3LC0xMDY0NjgwNDM1LC0xNj
