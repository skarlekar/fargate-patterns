...
We will use the Scaling-Container to build the Bean-Counter auto-scaling service that finds the value of the coins thrown on a table.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxOTA4NzI3MywyNjA4NDQzNTQsLTE3ND
M0NjQ0NjldfQ==
-->