...
- **ECS Service** - An ECS service that uses the Fargate Task from above identifying the desired count of tasks that 

<!--stackedit_data:
eyJoaXN0b3J5IjpbMjI2MjUxNjMsMTkzNDA5OTY1NiwtMTI0MD
